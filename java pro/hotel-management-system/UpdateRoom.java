...
//       panel.add(label);
       ...
       try{
        ...
        ResultSet resultSet1 = c.statement.executeQuery("select * from room whwere roomnumber = '"+textField3.getText()+ "'");

        while (resultSet1.next()){
            textField4.setText(resultSet1.getString("availablility"));
